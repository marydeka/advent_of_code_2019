...
#for each intersection, calculate the Manhattan Distance, and append to a list called distances
distances = [abs(int(point.split(":")[0])) + abs(int(point.split(":")[1])) for point in intersections ]
